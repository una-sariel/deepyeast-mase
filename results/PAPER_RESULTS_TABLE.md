...
| MaSE Lite **v9 RSB** | — | **86.28%** / learned ref **88.96%** | [0.21, 0.22, 0.24, 0.33] | per-image random top-k; RSB < learned |
| MaSE Lite **v10 SFRM** | **85.09%** / vote **84.27%** | — | frozen 0.25×4 | shared region, S=24; vote hurt |
| MaSE Lite **v10+sel** | **85.71%** | — | frozen 0.25×4 | keep selector, S=16; −0.16pp vs v4 |
...
- v8 full: `results/v8/results.json` (train 0.8905); `results/v8/tta_summary.json` (0.8969)
- v9 full: `results/v9/results.json` (random 0.8487); `results/v9/rsb_summary.json` (RSB 0.8628, learned 0.8896)
- v10 5%: `results/v10/5pct_results.json` (unmasked 0.8509); `results/v10/5pct_vote_summary.json` (vote 0.8427)
- v10+sel 5%: `results/v10/5pct_sel_results.json` (test 0.8571)
